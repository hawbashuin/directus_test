import { customRef, computed, ref, onMounted, resolveComponent, resolveDirective, openBlock, createBlock, withCtx, createVNode, withKeys, createElementBlock, Fragment, renderList, unref, createTextVNode, toDisplayString, withModifiers, withDirectives, createElementVNode, isRef } from 'vue';
...
`:void 0}function fP(e){if(this.resolvedSpec.securitySchemes&&e){const t=[];return Array.isArray(e)?0===e.length?"":(e.forEach((e=>{const r=[],n=[];0===Object.keys(e).length?t.push({securityTypes:"None",securityDefs:[]}):(Object.keys(e).forEach((t=>{let o="";const a=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(o=e[t].join(", ")),a&&(n.push(a.typeDisplay),r.push({...a,scopes:o}));})),t.push({securityTypes:n.length>1?`${n[0]} + ${n.length-1} more`:n[0],securityDefs:r}));})),q`<div style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
  ...
  <div class="tab-panel col"
    ...
    `))}
  `}const gP={},vP=J_(class extends Y_{constructor(){super(...arguments),this.ot=gP;}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every(((e,t)=>e===this.ot[t])))return U}else if(this.ot===t)return U;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,r)}}),xP={},wP=J_(class extends Y_{constructor(e){if(super(e),e.type!==G_&&e.type!==W_&&e.type!==K_)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===U||t===z)return t;const r=e.element,n=e.name;if(e.type===G_){if(t===r[n])return U}else if(e.type===K_){if(!!t===r.hasAttribute(n))return U}else if(e.type===W_&&r.getAttribute(n)===t+"")return U;return ((e,t=xP)=>{e._$AH=t;})(e),t}});var $P=r(131),kP=r.n($P);const SP=c`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
const _hoisted_1 = { class: "pb20" };
const _hoisted_2 = { class: "flex" };
const _hoisted_3 = /*#__PURE__*/createElementVNode("div", { class: "type-label" }, "Display mode", -1 /* HOISTED */);
const _hoisted_4 = { class: "flex center" };
const _hoisted_5 = { class: "layout-options" };
const _hoisted_6 = { class: "pb20" };
const _hoisted_7 = { class: "flex" };
const _hoisted_8 = /*#__PURE__*/createElementVNode("div", { class: "type-label" }, "Show method in navbar", -1 /* HOISTED */);
const _hoisted_9 = { class: "pb20" };
const _hoisted_10 = { class: "flex" };
const _hoisted_11 = /*#__PURE__*/createElementVNode("div", { class: "type-label" }, "Sort endpoints", -1 /* HOISTED */);
const _hoisted_12 = { class: "pb20" };
const _hoisted_13 = { class: "flex" };
const _hoisted_14 = /*#__PURE__*/createElementVNode("div", { class: "type-label" }, "Navbar active item", -1 /* HOISTED */);
const _hoisted_15 = { class: "pb20" };
const _hoisted_16 = { class: "flex" };
const _hoisted_17 = /*#__PURE__*/createElementVNode("div", { class: "type-label" }, "Item spacing", -1 /* HOISTED */);
const _hoisted_18 = { class: "pb20" };
const _hoisted_19 = { class: "flex" };
const _hoisted_20 = /*#__PURE__*/createElementVNode("div", { class: "type-label" }, "Font size", -1 /* HOISTED */);
const _hoisted_21 = { class: "flex center" };
const _hoisted_22 = { class: "flex center" };
const _hoisted_23 = { class: "flex center" };
const _hoisted_24 = { class: "flex center" };
const _hoisted_25 = { class: "flex center" };
const _hoisted_26 = { class: "flex center" };
const _hoisted_27 = { class: "flex center" };
...
return (_ctx, _cache) => {
  const _component_rapi_doc = resolveComponent("rapi-doc");
  ...
  return (openBlock(), createBlock(_component_private_view, {
      ...
      createVNode(_component_v_menu, {
        ...
        activator: withCtx(({ toggle }) => [
          createVNode(_component_v_input, {
            ...
            small: "",
            onKeyup: withKeys(loadSpec, ["enter"])
          }, null, 8 /* PROPS */, ["onClick", "modelValue"])
        ]),
        default: withCtx(() => [
          createVNode(_component_v_list, null, {
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(urls), (url) => {
                return (openBlock(), createBlock(_component_v_list_item, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_v_list_item_content, null, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(url), 1 /* TEXT */)
                      ]),
                      _: 2 /* DYNAMIC */
                    }, 1024 /* DYNAMIC_SLOTS */),
                    createVNode(_component_v_list_item_icon, {
                      onClick: withModifiers(removeUrl, ["stop"])
                    }, {
                      default: withCtx(() => [
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_1, [
            ...
            createVNode(_component_v_select, {
              modelValue: unref(display_mode),
              "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => (isRef(display_mode) ? (display_mode).value = $event : null)),
              items: unref(display_modes)
            }, null, 8 /* PROPS */, ["modelValue", "items"])
          ]),
          createElementVNode("div", _hoisted_4, [
            createVNode(_component_v_checkbox, {
              class: "type-label",
              modelValue: unref(allow_try),
              "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => (isRef(allow_try) ? (allow_try).value = $event : null))
            }, {
              default: withCtx(() => [
                createTextVNode("Allow try ")
              ]),
              _: 1 /* STABLE */
            }, 8 /* PROPS */, ["modelValue"]),
            withDirectives(createVNode(_component_v_icon, {
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_5, [
            createElementVNode("div", _hoisted_6, [
              ...
              createVNode(_component_v_select, {
                modelValue: unref(show_method_in_nav_bar),
                "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => (isRef(show_method_in_nav_bar) ? (show_method_in_nav_bar).value = $event : null)),
                items: show_methods_in_nav_bar.value
              }, null, 8 /* PROPS */, ["modelValue", "items"])
            ]),
            createElementVNode("div", _hoisted_9, [
              ...
              createVNode(_component_v_select, {
                modelValue: unref(sort_endpoints),
                "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => (isRef(sort_endpoints) ? (sort_endpoints).value = $event : null)),
                items: sort_endpoints_by.value
              }, null, 8 /* PROPS */, ["modelValue", "items"])
            ]),
            createElementVNode("div", _hoisted_12, [
              ...
              createVNode(_component_v_select, {
                modelValue: unref(nav_active_item_marker),
                "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => (isRef(nav_active_item_marker) ? (nav_active_item_marker).value = $event : null)),
                items: nav_active_items_marker.value
              }, null, 8 /* PROPS */, ["modelValue", "items"])
            ]),
            createElementVNode("div", _hoisted_15, [
              ...
              createVNode(_component_v_select, {
                modelValue: unref(item_spacing),
                "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => (isRef(item_spacing) ? (item_spacing).value = $event : null)),
                items: item_spacings.value
              }, null, 8 /* PROPS */, ["modelValue", "items"])
            ]),
            createElementVNode("div", _hoisted_18, [
              ...
              createVNode(_component_v_select, {
                modelValue: unref(font_size),
                "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => (isRef(font_size) ? (font_size).value = $event : null)),
                items: font_sizes.value
              }, null, 8 /* PROPS */, ["modelValue", "items"])
            ]),
            createElementVNode("div", _hoisted_21, [
              createVNode(_component_v_checkbox, {
                modelValue: unref(show_info),
                "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => (isRef(show_info) ? (show_info).value = $event : null))
              }, {
                default: withCtx(() => [
                  createTextVNode("Show info")
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["modelValue"]),
              withDirectives(createVNode(_component_v_icon, {
            ...
            createElementVNode("div", _hoisted_22, [
              createVNode(_component_v_checkbox, {
                modelValue: unref(allow_server_selection),
                "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => (isRef(allow_server_selection) ? (allow_server_selection).value = $event : null))
              }, {
                default: withCtx(() => [
                  createTextVNode("Allow server selection")
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["modelValue"]),
              withDirectives(createVNode(_component_v_icon, {
            ...
            createElementVNode("div", _hoisted_23, [
              createVNode(_component_v_checkbox, {
                modelValue: unref(allow_authentication),
                "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => (isRef(allow_authentication) ? (allow_authentication).value = $event : null))
              }, {
                default: withCtx(() => [
                  createTextVNode("Allow authentication")
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["modelValue"]),
              withDirectives(createVNode(_component_v_icon, {
            ...
            createElementVNode("div", _hoisted_24, [
              createVNode(_component_v_checkbox, {
                modelValue: unref(persist_auth),
                "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => (isRef(persist_auth) ? (persist_auth).value = $event : null))
              }, {
                default: withCtx(() => [
                  createTextVNode("Persist auth")
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["modelValue"]),
              withDirectives(createVNode(_component_v_icon, {
            ...
            createElementVNode("div", _hoisted_25, [
              createVNode(_component_v_checkbox, {
                modelValue: unref(allow_search),
                "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => (isRef(allow_search) ? (allow_search).value = $event : null))
              }, {
                default: withCtx(() => [
                  createTextVNode("Allow search")
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["modelValue"]),
              withDirectives(createVNode(_component_v_icon, {
            ...
            createElementVNode("div", _hoisted_26, [
              createVNode(_component_v_checkbox, {
                modelValue: unref(allow_advanced_search),
                "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => (isRef(allow_advanced_search) ? (allow_advanced_search).value = $event : null))
              }, {
                default: withCtx(() => [
                  createTextVNode("Allow advanced search")
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["modelValue"]),
              withDirectives(createVNode(_component_v_icon, {
            ...
            createElementVNode("div", _hoisted_27, [
              createVNode(_component_v_checkbox, {
                modelValue: unref(use_path_in_nav_bar),
                "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => (isRef(use_path_in_nav_bar) ? (use_path_in_nav_bar).value = $event : null))
              }, {
                default: withCtx(() => [
                  createTextVNode("Use path in navbar")
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["modelValue"]),
              withDirectives(createVNode(_component_v_icon, {
    ...
    default: withCtx(() => [
      createVNode(_component_rapi_doc, {
        ref_key: "rapidoc",
        ref: rapidoc,
        style: {"height":"calc(100% - 60px)","width":"100%"},
        "render-style": unref(display_mode),
        theme: mode.value,
        "show-header": "false",
        "allow-spec-file-load": "false",
        "allow-spec-url-load": "false",
        "show-info": unref(show_info),
        "allow-server-selection": unref(allow_server_selection),
        "allow-authentication": unref(allow_authentication),
        "allow-search": unref(allow_search),
        "allow-advanced-search": unref(allow_advanced_search),
        "show-method-in-nav-bar": unref(show_method_in_nav_bar),
        "nav-active-item-marker": unref(nav_active_item_marker),
        "nav-item-spacing": unref(item_spacing),
        "font-size": unref(font_size),
        "allow-try": unref(allow_try),
        "header-color": colors.value.header,
        "bg-color": colors.value.bg,
        "primary-color": colors.value.primary,
        "nav-bg-color": colors.value.navBg,
        "nav-text-color": colors.value.navText,
        "persist-auth": unref(persist_auth),
        "sort-endpoints-by": unref(sort_endpoints),
        "use-path-in-nav-bar": unref(use_path_in_nav_bar),
        "allow-schema-description-expand-toggle": "false"
      }, null, 8 /* PROPS */, ["render-style", "theme", "show-info", "allow-server-selection", "allow-authentication", "allow-search", "allow-advanced-search", "show-method-in-nav-bar", "nav-active-item-marker", "nav-item-spacing", "font-size", "allow-try", "header-color", "bg-color", "primary-color", "nav-bg-color", "nav-text-color", "persist-auth", "sort-endpoints-by", "use-path-in-nav-bar"])
    ]),
    _: 1 /* STABLE */
  }))
}
